import s from "./ruby-Bwg0ofHw.js";
...
function l(a) {
  a.register(s), (function(e) {
    ...
    for (var u = "((?:^|\\r?\\n|\\r)([\\t ]*)):{{filter_name}}(?:(?:\\r?\\n|\\r)(?:\\2[\\t ].+|\\s*?(?=\\r?\\n|\\r)))+", r = ["css", { filter: "coffee", language: "coffeescript" }, "erb", "javascript", "less", "markdown", "ruby", "scss", "textile"], i = {}, n = 0, o = r.length; n < o; n++) {
      var t = r[n];
      t = typeof t == "string" ? { filter: t, language: t } : t, e.languages[t.language] && (i["filter-" + t.filter] = { pattern: RegExp(u.replace("{{filter_name}}", function() {
        return t.filter;
      })), lookbehind: true, inside: { "filter-name": { pattern: /^:[\w-]+/, alias: "symbol" }, text: { pattern: /[\s\S]+/, alias: [t.language, "language-" + t.language], inside: e.languages[t.language] } } });
    }
