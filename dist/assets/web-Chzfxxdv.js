import { W as p, __tla as __tla_0 } from "./index-DM8mm4VO.js";
let f;
let __tla = Promise.all([
  ...
  f = class extends p {
    ...
    async get(e) {
      return {
        value: this.impl.getItem(this.applyPrefix(e.key))
      };
    }
    async set(e) {
    ...
    async keys() {
      return {
        keys: this.rawKeys().map((t) => t.substring(this.prefix.length))
      };
    }
    async clear() {
    ...
    async migrate() {
      ...
      for (const i of o) {
        const r = i.substring(n.length), a = (e = this.impl.getItem(i)) !== null && e !== void 0 ? e : "", { value: l } = await this.get({
          key: r
        });
        typeof l == "string" ? s.push(r) : (await this.set({
          key: r,
          value: a
        }), t.push(r));
      }
