import l from "./markup-templating-C-XwH7hP.js";
...
function i(n) {
  n.register(l), (function(e) {
    ...
    var s = /"(?:\\.|[^"\\\r\n])*"|'(?:\\.|[^'\\\r\n])*'/, o = RegExp(/\{\*[\s\S]*?\*\}/.source + "|" + /\{php\}[\s\S]*?\{\/php\}/.source + "|" + /\{(?:[^{}"']|<str>|\{(?:[^{}"']|<str>|\{(?:[^{}"']|<str>)*\})*\})*\}/.source.replace(/<str>/g, function() {
      return s.source;
    }), "g");
    e.hooks.add("before-tokenize", function(t) {
      var p = "{literal}", d = "{/literal}", a = false;
      e.languages["markup-templating"].buildPlaceholders(t, "smarty", o, function(r) {
        return r === d && (a = false), a ? false : (r === p && (a = true), true);
      });
