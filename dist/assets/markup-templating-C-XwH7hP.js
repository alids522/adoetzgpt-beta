...
function _(g) {
  g.register(S), (function(e) {
    ...
    Object.defineProperties(e.languages["markup-templating"] = {}, { buildPlaceholders: { value: function(a, r, f, p) {
      if (a.language === r) {
        var u = a.tokenStack = [];
        a.code = a.code.replace(f, function(n) {
          if (typeof p == "function" && !p(n)) return n;
          for (var i = u.length, t; a.code.indexOf(t = s(r, i)) !== -1; ) ++i;
          return u[i] = n, t;
        }), a.grammar = e.languages.markup;
      }
    } }, tokenizePlaceholders: { value: function(a, r) {
      if (a.language !== r || !a.tokenStack) return;
      ...
      function u(n) {
        for (var i = 0; i < n.length && !(f >= p.length); i++) {
          ...
          if (typeof t == "string" || t.content && typeof t.content == "string") {
            ...
            if (l > -1) {
              ++f;
              var h = c.substring(0, l), b = new e.Token(r, e.tokenize(d, a.grammar), "language-" + r, d), v = c.substring(l + k.length), o = [];
